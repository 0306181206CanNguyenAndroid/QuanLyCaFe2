...
values (N'Mì ăn liền',convert(datetime,'2021-07-03'),1,convert(datetime,'2021-07-03'),1,0)

--- San pham, mac hang ---
insert into [P_Product]([Name],[Description],[ManuId],ProductTypeId,[CreatedDate],[CreatedUserId],[ModifiedDate],[ModifiedUserId],[IsDeleted],[Status])
values (N'Mì Kokomi Tôm chua cay',N'Mì ăn liền',1,1,convert(datetime,'2021-07-03'),1,convert(datetime,'2021-07-03'),1,0,0)
